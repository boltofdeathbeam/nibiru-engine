...
namespace NibiruPipeline
{
	...
	public class TerrainContent
	{
		...
		/// array.
		/// </summary>
		public TerrainContent(PixelBitmapContent<float> bitmap,
	...
	/// </summary>
	[ContentTypeWriter]
	public class TerrainContentWriter : ContentTypeWriter<TerrainContent>
	{
		...
		{
			return "Nibiru.TerrainContent, NibiruEngine";
		}
		...
		{
			return "Nibiru.TerrainContentReader, NibiruEngine";
		}
	}
}
