...
namespace NibiruPipeline
{
	...
	/// </summary>
	[ContentTypeWriter]
	class ParticleContentWriter : ContentTypeWriter<ParticleContent>
	{
		protected override void Write(ContentWriter output, ParticleContent value)
		{
		...
		{
			return "Nibiru.ParticleContent, NibiruEngine";
		}

		public override string GetRuntimeReader(TargetPlatform targetPlatform)
		{
			return "Nibiru.ParticleContentReader, NibiruEngine";
		}
	}
}
