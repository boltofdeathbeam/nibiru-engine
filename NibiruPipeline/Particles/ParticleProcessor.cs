...
namespace NibiruPipeline
{
	...
	/// </summary>
	[ContentProcessor]
	class ParticleProcessor : ContentProcessor<ParticleContent,
											   ParticleContent>
	{
		public override ParticleContent Process(ParticleContent input,
														ContentProcessorContext context)
		{
			...
			effect.Effect = new ExternalReference<EffectContent>(@"Effects\particle.fx");

			// Set the texture to be used by this material.
			effect.Textures["Texture"] = new ExternalReference<TextureContent>(input.TextureName + ".png");
			...
			input.ParticleEffect = context.Convert<MaterialContent,
												   MaterialContent>(effect, "MaterialProcessor");
