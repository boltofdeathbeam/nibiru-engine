...
namespace Nibiru
{
	...
	public class TerrainContent
	{
		...
		public TerrainContent(float[,] heights, float terrainScale)
		{
			if (heights == null)
			{
	...
	/// </summary>
	public class TerrainContentReader : ContentTypeReader<TerrainContent>
	{
		protected override TerrainContent Read(ContentReader input, TerrainContent existingInstance)
		{
			...
			return new TerrainContent(heights, terrainScale);
		}
	}
}
