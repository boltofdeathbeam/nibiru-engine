...
namespace Nibiru
{
	...
	{
		public static void IfNull(Object thrower, string name, Object obj)
		{
			if (obj == null)
			{
				string message = "Exception Thrown: Value is null ["+name+"].";

				Log.Write(thrower, message, LogLevels.Error);
